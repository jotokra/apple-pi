...
// 25 ms. The ceiling is 8 s (not 3 s) because the full regression runs every
// test file in ONE node process, so fsevents + the debounce timer contend with
// 470+ other tests for the event loop and a real callback can land past 3 s.
// A higher ceiling cannot mask a real bug (a broken path never satisfies the
// poll); it only stops a loaded runner from false-failing. See operator pass
// 2026-07-09 (this flake halted M7-2..M9-5).
